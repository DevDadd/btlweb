...
export default function SignupCard({ onSubmit, isSubmitting, errorMessage }) {
    ...
    async function handleSubmit(event) {
        ...
        await onSubmit({ username: username.trim(), password, email: email.trim() });
    }
    ...
    return (
        ...
        >
            ...
            <p className="mb-6 text-center text-sm text-white/70">
                Sign up to continue your training journey
            </p>
            ...
            <p className="text-center text-sm text-white/70">
                ...
                <Link to="/login" className="cursor-pointer font-medium text-red-500">Login</Link>
            </p>
        </form>
    );
}
